    ...
    <div class="paquetes__grid">
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Virtual a Digitalis</li>
            </ul>
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Presencial a Digitalis</li>
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Virtual a Digitalis</li>
                <li class="paquete__elemento">Pase por 2 días</li>
                <li class="paquete__elemento">Acceso a talleres y cursos</li>
                <li class="paquete__elemento">Acceso a las grabaciones</li>
            </ul>
