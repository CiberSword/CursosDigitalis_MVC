...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Miembros</p>
        </div>
    </div>
</section>
...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de Digitalis</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios en Digitalis</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">Digitalis /></h4>
            <p class="boleto__plan">Anual</p>
            <p class="boleto__precio">$1999</p>
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">Digitalis /></h4>
            <p class="boleto__plan">Mensual</p>
